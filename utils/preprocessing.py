...
def prepare_sequential_test(test_doc, test_answer, 
                       max_document_length=1000,
                       max_vocabulary_size=50000,
                       embeddings_size=50,
                       stem_test = False):
...
#    logging.debug("Building embedding matrix of size [%s,%s]..." % (num_words, embeddings_size))
    ...
    return test_x, embedding_matrix

def prepare_sequential_test2(test_doc, test_answer, 
                       max_document_length=1000,
                       max_vocabulary_size=50000,
                       embeddings_size=50,
                       stem_test = False):
...
#        print("doc_answers_set",doc_answers_set)
